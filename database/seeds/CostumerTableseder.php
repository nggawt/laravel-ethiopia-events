...
class CostumerTableseder extends Seeder
{
    ...
    public function run()
    {
       costumer::create([
            ...
            "loggo" => "./assets/pages/costumers/halls_events/palace_lev/123.png",
       ...
       costumer::create([
            ...
            "loggo" => "./assets/pages/costumers/halls_events/benistal/benistal.jpg",
       ...
       costumer::create([
            ...
            "contact" =>  "הנהלה",
            "title" =>  "גולדן קראון",
            "loggo" =>  "./assets/pages/costumers/halls_events/golden/golden.jpg",
       ...
       costumer::create([
	        ...
	        "contact" => "הנהלה",
	        "title" => "סילבר אירועים ",
	        "loggo" => "./assets/pages/costumers/halls_events/silver/silver.jpg",
       ...
       costumer::create([
	    	...
	    	"title" => "גולדן קראון",
	    	"loggo" => "./assets/pages/costumers/halls_events/golden/golden.jpg",
	    	"discription" => 'גולדן קראון. מרכז ארועים. 3 אולמות מפוארים עומדים לרשותכם. חתונות,
	    	בר מצווה, בריתות, כנסים עד 900 איש. אולם מיוחד לחינות בסגנון מרוקאי עד 250 איש. 
    	...
    	costumer::create([
	    	...
	    	"title" =>  "ארמונות בינסטל ",
	    	"loggo" =>  "./assets/pages/costumers/halls_events/benistal/benistal.jpg",
	    	"discription" =>  'בהנהלתו החדשה של יצחק פדידה,מציעים לכם שלושה אולמות 
	    	מפוארים הקרויים בשמות אבני החושן,המתאימים לכם לכל אירוע בכל סדר גודל.
	    	אולם ספיר-עד 180 איש.
	    	אולם ברקת-עד 280 איש.
	    	אולם יהלום-עד 600 איש.
	    	',
	    	"email" =>  "benistal2@gmil.com",
	    	"tel" =>  "08-8522668, 08822669",
	    	"address" => "אשדוד",
	    	"deals" =>  ""
    	]);
