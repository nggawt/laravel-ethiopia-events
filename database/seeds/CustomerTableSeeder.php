    ...
    public function run()
    {
       Customer::create([
            ...
            "descriptions" => "אולמות לב השוכנים בקניון לב באשקלון מתגאים בעיצוב חדש, איכותי ויוקרתי מאין כמוהו
             ובהנהלה חדשה, שמעניקה למקום מניסיונה העשיר. האחים לב, המפורסמים והפעילים בתחום הפקת ה",

            "content" => 'אולמות לב השוכנים בקניון לב באשקלון מתגאים בעיצוב חדש, איכותי ויוקרתי מאין כמוהו
       ...
       Customer::create([
            ...
            "descriptions" => 'נהלתו החדשה של יצחק פדידה,מציעים לכם שלושה אולמות ',
            "content" => 'הנהלתו החדשה של יצחק פדידה,מציעים לכם שלושה אולמות 
       ...
       Customer::create([
            ...
            "content" =>  'ולדן קראון. מרכז ארועים. 3 אולמות מפוארים עומדים לרשותכם. חתונות,
       ...
       Customer::create([
	        ...
	        "content" => 'סילבר...אולם אירועים ששודרג זה עתה לפי מיטב הקידמה והטכנולוגיה,בכירי
