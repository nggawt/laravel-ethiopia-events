...
class CustomersTableSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       Customer::create([
            ...
            "descritions" => 'אולמות לב השוכנים בקניון לב באשקלון מתגאים בעיצוב חדש, איכותי ויוקרתי מאין כמוהו
       ...
       Customer::create([
            ...
            "descritions" => 'הנהלתו החדשה של יצחק פדידה,מציעים לכם שלושה אולמות 
       ...
       Customer::create([
            ...
            "descritions" =>  'ולדן קראון. מרכז ארועים. 3 אולמות מפוארים עומדים לרשותכם. חתונות,
       ...
       Customer::create([
	        ...
	        "descritions" => 'סילבר...אולם אירועים ששודרג זה עתה לפי מיטב הקידמה והטכנולוגיה,בכירי
